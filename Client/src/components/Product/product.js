...
function ProductComponent() {
  ...
  const updateProduct = async (productId) => {
    ...
    if (productStock !== '') payload.stock = productStock;
                  ...
                  <Form onSubmit={handleSubmit}>
                    ...
                    <Row>
                      ...
                      <Col xs={4}>
                        <Form.Group controlId="price">
                          ...
                          <Form.Control type="number" name="price" placeholder={'e.g. 500'} onChange={(e) => setPrice(e.target.value)} required />
                        </Form.Group>
                      </Col>
                      <Col xs={4}>
                    ...
                    <Row>
                      <Col xs={4}>
                        ...
                        <Form.Control as="select" name="fabric">
                    ...
                    <Row>
                      ...
                      <Col>
                        <Form.Group controlId="stock">
                          ...
                          <Form.Control type="number" name="stock" placeholder={'e.g. 100'} onChange={(e) => setStock(e.target.value)} required />
                        </Form.Group>
                      </Col>
                      ...
                      <Col>
                        <Form.Group controlId="stock">
                          ...
                          <Form.Control type="number" name="stock" placeholder={'e.g. 100'} />
                        </Form.Group>
                      </Col>
